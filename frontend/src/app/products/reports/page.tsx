...
import { LineChart, Bot, LayoutDashboard, Share2 } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "6 native chart types (Bar, Line, Scatter, Pie, Donut, Box Plot) let you slice and dice your data visually."
    },
    {
      icon: <Bot size={24} style={{ color: "var(--accent)" }} />,
      title: "Gemini AI Summaries",
      description: "Get instant, natural-language executive summaries of your dataset generated by Google's Gemini 2.5."
    },
    {
      icon: <LayoutDashboard size={24} style={{ color: "var(--accent)" }} />,
      title: "Custom Chart Builder",
      description: "Use the built-in builder to create custom pivot charts and pin them directly to your dashboard."
    },
    {
      icon: <Share2 size={24} style={{ color: "var(--accent)" }} />,
      title: "14-Plugin Insight Engine",
      description: "Automatically run Trend, Anomaly, Correlation, and Forecast algorithms over your dashboard to uncover hidden patterns."
    }
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col transition-colors duration-300" style={{ background: "var(--bg)", color: "var(--txt)" }}>
          ...
          <div className="lg:w-1/2 lg:sticky lg:top-32 self-start relative">
            ...
            >
              ...
              <h1 className="font-black mb-6 tracking-tight transition-colors duration-300 leading-[1.1]" style={{ fontSize: "clamp(2rem,5vw,3.8rem)", color: "var(--txt)" }}>
                See the Story.<br/>
                <span style={{ color: "var(--accent)" }}>Not just the numbers.</span>
              </h1>
              <p className="text-sm font-light leading-relaxed transition-colors duration-300 max-w-md" style={{ color: "var(--txt-m)" }}>
                DataForge transforms raw tables into beautiful, interactive dashboards and AI-generated executive summaries.
              </p>
            </motion.div>
          </div>
      ...
      <CTABanner 
        ...
        subtitle="Upload your dataset and generate dashboards now."
        buttonText="Upload Your Dataset"
        href="/?login=1"
        bgColor="linear-gradient(to top right, #60a5fa, #6366f1)"
        btnTextColor="#60a5fa"
      />
